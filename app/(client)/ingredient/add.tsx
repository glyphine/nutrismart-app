      ...
      <View className="space-y-4">
        ...
        <View className="py-2">
          ...
          <TextInput
            ...
            } bg-blue-100 rounded-lg px-4 py-3 text-base text-black font-noto`}
            value={name}
            onChangeText={(val) => {
              setName(val);
        ...
        <View className="py-2">
          ...
          <TextInput
            className="mt-2 border border-primary bg-blue-100 rounded-lg px-4 py-3 text-base text-black  font-noto"
